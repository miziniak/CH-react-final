      ...
      <>
        <div className="container">
          <div className="py-5 text-center mt-5">
            <h2 className="display-5 fw-bold mt-5">You just did it!</h2>
            <h4 className="mb-5"><strong>Wohoo!</strong> Simulacro de compra realizada con éxito</h4>
            <div>
              <p><strong>El ID de tu compra es {orderId}</strong></p>
              <img
              style={{
                  width: "100px",
                  marginTop:"10px"
